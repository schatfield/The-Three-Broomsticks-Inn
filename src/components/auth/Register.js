...
class Register extends Component {
  ...
  handleRegistration = (evt) => {
    ...
    // If Not same return False.
      ...
      UserManager.searchUser(this.state.registeredEmail).then(
        (existingUser) => {
          ...
          if (existingUser.length === 0) {
            ...
            UserManager.postNewUser(newUserObj).then(() => {
              // get user that we just posted
              UserManager.getUserByEmail(this.state.registeredEmail).then(
                (users) => {
                  users.forEach((user) => {
              ...
              <a>
                ...
                >
                  <img
                    ...
                    src={require("./register_mauve.png")}
                    alt=""
